  ...
  renderIcons(links: string[]) {
    return (
      <div className="footerSocial">
        <span>
          <a
            href="https://www.facebook.com/themeetinghousechurch/"
        ...
        <span>
          <a
            href="https://twitter.com/TheMeetingHouse"
            rel="noopener noreferrer"
            target="_blank"
            className="link-plain FooterSocialA"
            style={{ whiteSpace: 'nowrap', color: '#1A1A1A' }}
        ...
        <span>
          <a
            href="https://www.youtube.com/themeetinghouse"
            rel="noopener noreferrer"
            target="_blank"
            className="link-plain FooterSocialA"
            style={{ whiteSpace: 'nowrap', color: '#1A1A1A' }}
        ...
        <span>
          <a
            href="https://www.instagram.com/themeetinghouse/"
            rel="noopener noreferrer"
            target="_blank"
            className="link-plain FooterSocialA"
            style={{ whiteSpace: 'nowrap', color: '#1A1A1A' }}
