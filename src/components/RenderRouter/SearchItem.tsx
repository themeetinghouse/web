          ...
          <div className="SearchLinks">
            <div className="SearchLink HomeChurch">
              <img
                ...
                alt="Homechurch"
                onClick={() => {
                  this.navigateTo('/find-homechurch');
                }}
                src="/static/images/HC1.jpg"
              />
              <p>
                Find a home church{' '}
                <img alt="Go" src="\static\svg\ArrowRight.svg" />
              </p>
            </div>
            <div
              style={{ objectFit: 'cover' }}
              ...
              className="SearchLink Videos"
            >
              <img
                className="Image"
                alt="teaching"
                src="/static/images/homepage-4-1.jpg"
              />
              <p>Videos</p>
            </div>
