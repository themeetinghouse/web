...
export default class ContentItem extends React.Component<Props, State> {
  ...
  render() {
    return (
      <div className="FormItem iframeItemDiv1">
        <div className="oneImagePosition">
          ...
          {this.state.content.isInPopup ? (
            <iframe
              ...
              title="The Meeting House - IFrame"
              scrolling="no"
              className="iframeItemIframePopup"
              style={{ height: this.state.content.height }}
            ></iframe>
          ) : (
            <iframe
              src={this.state.content.src}
