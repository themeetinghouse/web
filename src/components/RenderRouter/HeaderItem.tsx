    ...
    return (
      <div className="headerItem">
        <div className="headerItemDiv">
          ...
          <Link to={this.state.content.link1Action}>
            {this.state.content.link1Text}
          </Link>
          <img
            src={image1.src}
            alt={image1.alt}
            className="example-mask"
            style={{
              maskImage: 'url("' + this.state.content.image1Mask + '")',
              WebkitMaskImage: 'url("' + this.state.content.image1Mask + '")',
              width: this.state.content.image1Width,
            }}
          />
        </div>
      </div>
