        ...
        return (
            <div className="headerItem" style={{ position: "static", paddingBottom: "5vw" }}>
                <div style={{ position: "relative", zIndex: 100 }}>
                    ...
                    <img src={this.state.data.image1Src} alt={this.state.data.image1Alt} className="example-mask" style={{ position: "absolute", top: "5vw", left: "58vw", maskImage: 'url("' + this.state.data.image1Mask + '")', WebkitMaskImage: 'url("' + this.state.data.image1Mask + '")', width: this.state.data.image1Width }} />
                </div>
            </div>
        )
    }
