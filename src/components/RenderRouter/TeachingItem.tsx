                    ...
                    (this.state.listData.length === this.props.content.options.length) || (this.props.content.options.length === 0) ?
                        <div className="teaching" >
                            ...
                            <div className="teaching-blackbox" >
                                ...
                                <div><img onClick={() => { this.handleClick(this.state.listData[this.state.teachingId]) }} alt="TBD" className="teaching-image" src={this.props.content.class === "teaching-sunday"&&this.state.listData[this.state.teachingId].seriesTitle!=null?("/static/photos/series/"+this.state.listData[this.state.teachingId].videoType+"-"+this.state.listData[this.state.teachingId].seriesTitle.replace("?","")+".jpg"):this.state.listData[this.state.teachingId].Youtube.snippet.thumbnails.standard.url} /></div>
                            </div>
