                    ...
                    (this.state.listData.length === this.props.content.options.length) || (this.props.content.options.length === 0) ?
                        <div className="teaching" >
                            ...
                            <div className="teaching-blackbox" >
                                ...
                                <div className="teachingdiv teachingseriestitle" >E{this.state.listData[this.state.teachingId].episodeNumber}. <span className="titleOnly" onClick={() => { this.handleClick(this.state.listData[this.state.teachingId]) }}>{this.state.listData[this.state.teachingId].seriesTitle}</span>  •  {this.state.listData[this.state.teachingId].Youtube.contentDetails.duration}</div>
                                ...
                                <div className="teachingdiv2" >
                                    <Button size="lg" className="teachingButton" onClick={() => { this.handleClick(this.state.listData[this.state.teachingId]) }} ><img className="teachingButton-icon" src="/static/svg/Watch.svg" alt="=>"/>Watch</Button>
                                    {this.state.listData[this.state.teachingId].notesURL!=null?<Button size="lg" className="teachingButton" onClick={() => { this.navigateUrlNewWindow(this.state.listData[this.state.teachingId].notesURL) }} ><img className="teachingButton-icon" src="/static/svg/Notes.svg" alt="=>"/>Notes</Button>:null}
                                </div>
