...
def main():
  ...
  client = boto3.client('lambda', aws_access_key_id=args.ak, aws_secret_access_key=args.sk, aws_session_token=args.st, region_name=args.rn)
...
def import_dynamodb_items_to_es(table_name, aws_secret, aws_access, aws_token, aws_region, event_source_arn, lambda_f, scan_limit):
  ...
  session = Session(profile_name='amplify',aws_access_key_id=aws_access, aws_secret_access_key=aws_secret, aws_session_token=aws_token, region_name=aws_region)
